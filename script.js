...
function renderExpenses(filteredExpenses = expenses) {
    ...
    filteredExpenses.forEach((expense, index) => {
      ...
      li.innerHTML = `
      ${expense.date} - ${expense.description} - ${expense.category} - R$ ${parseFloat(expense.amount).toFixed(2)}
          <div>
...
loadExpenses();
renderExpenses();
updateChart(); // gráfico será desenhado ao carregar a página
